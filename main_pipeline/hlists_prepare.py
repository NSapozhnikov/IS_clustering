...
def updateTableLOC(num_chr, filename):
    ### Update LOC column
    try:
...
def hdbscan_hlist(num_chr, filename):
    ### For HDBSCAN
    try:
...
def dbscan_hlist(num_chr, filename):    
    ### For DBSCAN    
    try:
...
# updateTableLOC(num_chr, filename)
# hdbscan_hlist(num_chr, filename)
# dbscan_hlist(num_chr, filename)
